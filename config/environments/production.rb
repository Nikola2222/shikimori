...
Rails.application.configure do
  ...
  config.consider_all_requests_local       = ENV['IS_LOCAL_RUN'].present?
  ...
  config.public_file_server.enabled = ENV['IS_LOCAL_RUN'].present?
  ...
  # config.active_job.queue_name_prefix = "shikimori_production"
